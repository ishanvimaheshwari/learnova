...
import { Textbook, SubjectType, BookChapter, UserProfile } from "../types";
          ...
          <div className="flex flex-wrap items-center gap-3">
            {onOpenGoogleAuth && (
              <button
                ...
                className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl bg-white hover:bg-slate-100 text-slate-900 font-bold text-sm shadow-md transition transform hover:-translate-y-0.5 cursor-pointer"
              >
